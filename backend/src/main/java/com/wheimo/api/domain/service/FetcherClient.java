...
public class FetcherClient {
    ...
    public SyncResultMessage parseXls(MultipartFile file, Long accountId, Long userId) throws Exception {
        ...
        ResponseEntity<SyncResultMessage> response = restTemplate.exchange(
                url, HttpMethod.POST, request, SyncResultMessage.class);
